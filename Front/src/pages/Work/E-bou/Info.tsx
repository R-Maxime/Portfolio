...
function Info(): React.ReactElement {
  return (
    <div className='work__long-description content-container'>
      <h1>E-bou est une application (bot) Discord relative au <a href='https://www.dofus.com/fr/prehome' target='_blank' style={{ fontSize: 'unset' }}><strong>MMORPG DOFUS</strong></a>.</h1>
      ...
      <p>L'application est disponible entièrement en français ainsi qu'en anglais, et partiellement en espagnol, Portugais et Allemand.</p>
    </div>
  );
}
